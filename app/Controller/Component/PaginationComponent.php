 ...
 * @access public
 */
    var $resultsPerPage = array(5,10,25,50,100,200);
/**
...
/**
 * Copy the paging url variables to session.
*/
	var $_session = false;
 ...
 */
    function _initSort()
    {
	    //echo "y";debug($this->modelClass); die;
        if (!$this->modelClass)
        {
 ...
 */
    function _setParameter($parameter,$parameters=Array(),$field=NULL)
    {
        ...
        else
        {
            if ($this->paramStyle=="get")
            {
                if (isset($_GET[$parameter]))
                {
					...
					//$_SESSION[$parameter] = $this->paging[$field];
                }
				/*//Added elseif condition by GSM
				elseif(isset($_SESSION[$parameter]))
				{
					$this->paging[$field] = $this->Sanitize->paranoid($_SESSION[$parameter],array("-","_"));
				}*/
		...
		//echo "~~~".$parameter.$this->paging[$field]."~~~";
    }
}
