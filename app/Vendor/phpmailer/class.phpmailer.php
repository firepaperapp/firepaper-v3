...
class phpmailer
{
     ...
     * @type string
     */
    var $ContentType        = EMAIL_CONTENT_TYPE;
     ...
     * @type string
     */
    var $From               = EMAIL_FROM_ADDRESS;//"root@localhost";
     ...
     * @type string
     */
    var $FromName           = EMAIL_FROM_NAME;//"Root User";
...
//    	echo $path;
        ...
        if(!@is_file($path))
        {
//            echo $this->error_handler(sprintf("Could not access [%s] file", $path));
...
//        echo count($this->attachment);die;
        // Add all attachments
