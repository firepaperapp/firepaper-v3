...
class MailerShell extends Shell { 
    ...
    function mail() { 
        ...
        $this->SwiftMailer->instance->smtpUsername = 'nsberrow@gmail.com'; 
        $this->SwiftMailer->instance->smtpPassword = 'steven1980'; 

        $this->SwiftMailer->instance->sendAs = 'html'; 
        $this->SwiftMailer->instance->from = 'nsberrow@gmail.com'; 
