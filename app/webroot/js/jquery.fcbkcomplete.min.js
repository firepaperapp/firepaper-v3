...
element.change();
		...
		var loaderCon = "undefined" == typeof(options.loaderDiv)?"containerLoader":options.loaderDiv;
                                    ...
                                    $.getJSON(options.json_url + ( options.json_url.indexOf("?") > -1 ? "&" : "?" ) + "tag=" + etext, null, function (data) {$('#'+loaderCon).empty().html();
                                    	 
                                        addMembers(etext, data);
                                        var errorDiv = "undefined" == typeof(options.errorDiv)?"showAddMore":options.errorDiv;
                                        	
                                        showAddMore(errorDiv, data);
                                        json_cache = true;
                                        bindEvents();
                                        //Fixed by manpreet for changing height of fancybox
                                        
                                        /*if($('#fancybox-wrap').css('display') == "block")
										{
											if(defaultFacyboxHeight=='')
											{
												defaultFacyboxHeight = $("#fancybox-content").height()+5;
											}
										    $("#contentDiv").animate({"height": defaultFacyboxHeight+$("#"+elemid+"_feed").height()+"px"}, "slow");
										 
										}*/
										//Fixed by manpreet End here
