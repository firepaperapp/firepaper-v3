...
(function($){
	...
	$.fn.slideBox = function(params){
		...
		// adding buttons
		$(divPanel).append("<div class='slide-button'>Project Drop Box</div>");
		$(divPanel).append("<div style='display: none' id='close-button' class='slide-button'>Project Drop Box</div>");
