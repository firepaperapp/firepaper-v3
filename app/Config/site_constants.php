...
$filesArray = array('3gp','7z','ace','ai','aif','aiff','amr','asf','asx','bat','bin','bmp','bup','cab','cbr','cda','cdl','cdr','chm','dat','divx','dll','dmg','doc','dss','dvf','docx','dwg','eml','eps','exe','fla','flv','gdraw','gif','gdoc','gslides','gsheet','gz','hqx','htm','html','ifo','indd','iso','jar','jpeg','jpg','lnk','log','m4a','m4b','m4p','m4v','mcd','mdb','mid','mov','mp2','mp4','mpg','mpeg','msi','mswmm','ogg','pdf','png','pps','ppt','pptx','ps','psd','pst','ptb','pub','qbb','qbw','qxd','ram','rar','rm','rmvb','rtf','sea','ses','sit','sitx','ss','swf','tgz','thm','tif','tmp','tiff','torrent','ttf','txt','vcd','vob','wav','wma','wmv','wps','xls','xlsx','xpi','zip');
