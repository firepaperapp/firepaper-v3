...
<div class="index">
	...
	<?php echo $this->Form->create('User', array('action'=>'updatePackage/'.$pkg['Package']['id'],'type' => 'post','id'=>'step2')); ?>
	  ...
	  <div class="col-left">
	    ...
	    <p>Card Type<span class="mandatory">*</span></p>
	      <?php echo $this->Form->input('cardtype',array('type'=>'select','div'=>false,'label'=>false,'options'=>$cardTypes,'id'=>'step2'));?>
	    <br />
