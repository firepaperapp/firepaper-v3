...
<div class="row">
	 ...
	 {// pr($students); exit;
	   ...
	   <?php }
		       ...
		       <?php echo SITE_HTTP_URL."users/viewProfile/".$students['User']['id'];?>
				<div class="links">
					<p class="title"><a id="edituserprof" href="<?php echo SITE_HTTP_URL."users/viewProfile/".$students['User']['id']; ?>"><b><?php echo ucfirst(Sanitize::html($students['User']['firstname']." ".$students['User']['lastname']));?></b></a>
					</p>
 					<?php 
