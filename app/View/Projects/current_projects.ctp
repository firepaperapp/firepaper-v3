...
<!-- End Progress bar -->
		...
		<h3>Details</h3>
			...
			<p><?php echo "<pre>"; print_r($_SERVER); die; $f_count = count(opendir($_SERVER['HTTP_HOST']."/dev/files/files".$rec['Project']['created_by'])) - 2; echo Sanitize::html($rec['Project']['description']);?>
